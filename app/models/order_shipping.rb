class OrderShipping
  ...
  attr_accessor :token, :user_id, :item_id, :postal_code, :area_id, :municipalities, :house_number, :building_name,
                :phone_number, :price
  ...
  def save
    ...
    Shipping.create(order_id: order.id, postal_code: postal_code, area_id: area_id, municipalities: municipalities,
